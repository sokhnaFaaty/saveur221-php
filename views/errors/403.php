...
<body class="font-sans text-gray-800 bg-gradient-to-br from-primary-light via-white to-white min-h-screen flex items-center justify-center p-6">
    ...
    <main class="w-full max-w-xl text-center">
        ...
        <div class="relative inline-block mb-8">
            <span class="text-[140px] font-extrabold leading-none text-primary/15 select-none">403</span>
        ...
        <h1 class="text-3xl md:text-4xl font-extrabold mb-3">Accès refusé</h1>
        <p class="text-gray-500 mb-2">Vous n'avez pas l'autorisation d'accéder à cette page.</p>
        <p class="text-gray-400 text-sm mb-8">Cette zone est réservée à certains utilisateurs. Si vous pensez que c'est une erreur, contactez un administrateur.</p>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="javascript:history.back()" class="w-full sm:w-auto px-6 py-3 rounded-lg border border-gray-300 text-gray-700 font-bold text-sm hover:border-primary hover:text-primary transition flex items-center justify-center gap-2">
