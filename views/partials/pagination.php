...
<div class="flex items-center justify-center gap-2 mt-6">
    ...
    <a href="?<?= http_build_query(array_merge($_GET, [$pageVar => $i])) ?>"
    ...
    <a href="?<?= http_build_query(array_merge($_GET, [$pageVar => $page + 1])) ?>" class="w-9 h-9 flex items-center justify-center rounded-lg bg-white border border-gray-200 hover:border-primary">
