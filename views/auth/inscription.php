...
<div class="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-5 md:p-7">
    ...
    <div class="text-center mb-5">
        <span class="inline-flex w-11 h-11 bg-primary rounded-2xl items-center justify-center shadow-lg mb-3">
            <i class="fa-solid fa-utensils text-white text-lg"></i>
        </span>
        <h1 class="text-2xl font-extrabold text-gray-800 leading-tight">Créez votre Compte Client</h1>
