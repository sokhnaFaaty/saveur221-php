<h1 class="text-white text-2xl md:text-[26px] font-extrabold text-center mb-4">Créez votre Compte Client</h1>
...
<div class="w-full max-w-xl bg-white rounded-2xl shadow-2xl p-5 md:p-6">
    ...
    <div class="flex flex-col items-center mb-3">
        ...
        <p class="text-xs text-gray-500 text-center mt-2.5">
            Rejoignez la communauté Saveur221 et bénéficiez de la livraison rapide à Dakar et de promotions exclusives.
        </p>
    </div>
